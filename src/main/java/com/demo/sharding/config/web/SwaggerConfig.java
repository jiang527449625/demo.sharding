package com.demo.sharding.config.web;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .pathMapping("/")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.demo.sharding.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("翊廷sharding服务- API")
                .description("翊廷sharding服务-API接口服务")
                .version("1.0.0")
